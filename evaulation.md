...
>Great job implementing a three model CRUD application and using users/sessions!

Creativity/Interface: **Preforming**

>I really like your design and CSS! The interface is really unique and has a minimal feel. Love it!

Code Quality: **Preforming**

>I think you did a great job overall! The only reason this isn't "excelling" was just because of the use of both a `guest` model and `user` model. Instead, I think you should try to implement a many to many relationship! While you certainly didn't have to for this project, It think it would extend a lot of additional functionality.

Deployment and Functionality: **Preforming**

>Your application is definitely functional and I did not find any bugs in the deployed version. Great job!

Planning Process/Submission: **Progressing**

>Great job with planning! Only suggestion would be too add alternative photos for your wireframes since it's difficult to see.
